  ...
  return (
    <div className="relative w-full aspect-square mx-auto bg-emerald-800/40 rounded-full border-2 border-emerald-700 shadow-lg">
      {seats.map((s) => {
        ...
        const cardPosClass =
          pos === 'bottom'
            ? 'bottom-12 md:bottom-16 lg:bottom-32 left-1/2 -translate-x-1/2'
            : pos === 'top'
            ? 'top-12 md:top-16 lg:top-32 left-1/2 -translate-x-1/2'
            : pos === 'left'
            ? 'left-12 md:left-16 lg:left-32 top-1/2 -translate-y-1/2'
            : 'right-12 md:right-16 lg:right-32 top-1/2 -translate-y-1/2';
        const bgColor =
          isWinner
